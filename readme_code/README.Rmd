...
This package implements the dynamic biases correction estimator as per Klosin, S, Dynamic Biases of Static Panel Data Estimators (forthcoming). This allows the estimation of treatment effects in panel fixed effects models where the outcome is dynamic.
...
The follows shows example usage of the DBC under three general types of model.
...
Last, the model that allows for interactions between the treatment variable and exogenous variables: 
